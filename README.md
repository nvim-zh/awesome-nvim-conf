...
|--------------|---------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|-----|
|    ofseed    |                 https://github.com/ofseed/nvim                |                                                                               Over 150+ featured plugins                                                                               |                     nvim-lsp, C/C++, Rust, GO, JavaScript, TypeScript, Java                    | 158 |
|     jdhao    |              https://github.com/jdhao/nvim-config             |                                           A modern Neovim configuration with full battery for Python, Lua, C++, Markdown, LaTeX, and more...                                           |                                     nvim-lsp, Python, LaTeX                                    | 4056|
...
|   qw457812   | https://github.com/qw457812/dotfiles/tree/main/dot_config/nvim|        A modern, modular Neovim config powered by LazyVim, with 130+ enabled plugins and 40+ available user extras. Used daily on macOS (Neovim nightly) and Android via Termux.       |              LazyVim, macOS, Termux, Chezmoi, AI, Kitty, VSCode, Lua, Java, Python             |  3  |
<!--MARKDOWN_TABLE_END-->
